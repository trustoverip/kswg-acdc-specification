...
1. The unique-entropy, `u`, field of the Registry inception event, `rip`, for copy `k` MUST be derived at the path `k.r`, that is, `k` followed by a period (`.`) followed by the letter `r`.
